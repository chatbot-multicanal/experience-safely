...
const INITIAL_EXPERIENCES = [
  ...
  },
  {
    ...
    price: 450,
    capacity: 25,
    image: '/images/homunja_cenote.webp',
    gallery: ['/images/homunja_cenote.webp', '/images/discover yucatan.jpeg', '/images/gastronomia.jpg', '/branding_2.jpg'],
    rating: 5.0,
    reviewsCount: 4,
    pricingType: 'individual',
    bookingType: 'tour',
  ...
  },
  {
    ...
    price: 1650,
    capacity: 6,
    image: '/images/rio_lagartos_coloradas.jpg',
    gallery: ['/images/rio_lagartos_coloradas.jpg', 'https://images.unsplash.com/photo-1559827291-72ee739d0d9a?auto=format&fit=crop&w=1200&q=80', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80', 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&w=1200&q=80'],
    rating: 5.0,
    reviewsCount: 6,
    pricingType: 'package',
    bookingType: 'tour',
  ...
  },
  {
    ...
    price: 850,
    capacity: 15,
    image: '/images/sayachaltun_kayak.webp',
    gallery: ['/images/sayachaltun_kayak.webp', '/images/gastronomia.jpg', 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=1200&q=80', '/images/catamaran.jpg'],
    rating: 4.9,
    reviewsCount: 5,
    pricingType: 'individual',
    bookingType: 'tour',
  ...
  },
  {
    ...
    safetyDescription: 'Instalaciones ventiladas con evaluación médica previa, hidratación electrolítica constante y personal capacitado en RCP.',
    providerId: 'provider-1',
    providerName: 'Aventuras Mayas S.A.',
    syncedFromWix: false,
  },
  {
    id: 'exp-padel-club',
    name: 'Yucatán Pádel Club — Canchas VIP, Clases & Torneos de Pádel',
    description: 'Experimenta las mejores instalaciones de pádel en Mérida. Renta canchas de cristal templado con iluminación LED profesional de noche, reserva clases particulares con instructores certificados o inscríbete a los torneos semanales con trofeos y premios.',
    category: 'deportes',
    ...
    schedules: ['07:00 AM', '09:00 AM', '05:00 PM', '07:00 PM', '09:00 PM'],
    reviews: [
      { id: 'rev-p1', author: 'Rodrigo V.', rating: 5, comment: 'Canchas espectaculares de noche, la iluminación LED no encandila y las clases con el pro son muy dinámicas.', date: '2026-08-12', source: 'Directo' }
    ],
    safetyBadges: ['Canchas Certificadas WPT', 'Iluminación LED Antirreflejo', 'Primeros Auxilios Deportivo'],
    safetyDescription: 'Canchas con piso sintético amortiguante para protección de rodillas, botiquín de traumatología deportiva e hidratación isotónica de cortesía.',
    providerId: 'provider-1',
    providerName: 'Yucatán Pádel Club & Sports Center',
    syncedFromWix: false,
  },
  {
...
const INITIAL_CATEGORIES = [
  ...
  { id: 'deportes', label: 'Deportes & Pádel' },
