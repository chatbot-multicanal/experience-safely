...
const TRANSLATIONS = {
  es: {
    ...
    chatBotName: 'SafeBot',
    chatBotGreeting: '¡Hola! 👋 Soy **SafeBot**, tu asistente de viaje seguro en Yucatán. ¿En qué puedo ayudarte?',
  ...
  en: {
    ...
    chatBotName: 'SafeBot',
    chatBotGreeting: 'Hi there! 👋 I\'m **SafeBot**, your safe travel assistant in Yucatán. How can I help you?',
