    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '24px 32px 32px' }}>
          ...
          {/* Official Native Google Sign-In Button Container & Fallback Selector */}
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', marginBottom: '16px' }}>
            <div id="googleBtnDiv" style={{ display: 'flex', justifyContent: 'center', minHeight: '44px', width: '100%' }}></div>
            ...
            <button
              ...
              onClick={() => {
                const userEmail = prompt(
                  language === 'es'
                    ? 'Ingresa tu dirección de correo de Google (@gmail.com) para ingresar:'
                    : 'Enter your Google email address (@gmail.com) to log in:'
                );
            ...
            >
              {language === 'es' ? '👤 Elegir o ingresar otro correo de Google' : '👤 Choose or enter another Google email'}
            </button>
          </div>
